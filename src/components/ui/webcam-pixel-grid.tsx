    ...
    <div className={cn("relative h-full w-full", className)}>
      ...
      {error && showErrorPopup && (
        <div className="animate-in fade-in slide-in-from-top-2 fixed top-4 right-4 z-50 duration-300">
          <div className="relative flex max-w-sm items-start gap-3 rounded-lg border border-border bg-black/80 p-4 shadow-2xl backdrop-blur-xl">
            {/* Close button */}
            <button
      ...
      {error && !showErrorPopup && (
        <button
          ...
          className="fixed top-4 right-4 z-50 flex h-10 w-10 items-center justify-center rounded-full border border-border bg-black/60 text-white/50 shadow-lg backdrop-blur-xl transition-all hover:scale-105 hover:bg-black/80 hover:text-white/80"
